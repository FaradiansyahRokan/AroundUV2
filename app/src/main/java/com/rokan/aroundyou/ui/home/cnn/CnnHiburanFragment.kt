...
import com.rokan.aroundyou.databinding.FragmentCnnHiburanBinding
...
class CnnHiburanFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.getCNNHiburanNews()
        commonViewModel.CNNHiburanNews.observe(viewLifecycleOwner) { newsResponse ->
