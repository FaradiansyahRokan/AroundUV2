...
import com.rokan.aroundyou.databinding.FragmentCnnEkonomiBinding
import com.rokan.aroundyou.ui.NewsViewModel
import com.rokan.aroundyou.utils.NewsViewModelFactory

class CnnEkonomiFragment : Fragment() {
    private lateinit var binding: FragmentCnnEkonomiBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCnnEkonomiBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.getCNNEkonomiNews()
        commonViewModel.CNNEkonomiNews.observe(viewLifecycleOwner) { newsResponse ->
            val articles = newsResponse.data?.posts
            articles?.let {
                mAdapter.setData(it.filterNotNull())
                binding.rvCnnEkonomi.apply {
                    adapter = mAdapter
